...
<h3 class="title-section">Item Ditolak</h3>
	...
	<div class="waiting-item">
		...
		<div class="content">
			...
			<div class="reason-list">
				@foreach($item->reject as $reject)
					<span> <img src="{{ asset('/assets/dashboard/icons/rejection_icon.svg') }}" alt="reject"> {{ $reject->reject->title }}</span>
				@endforeach
			</div>
		</div>
